public class Ular extends Hewan{
    ...
    public void bernapas() {
        System.out.println("Otot tulang rusuk kontraksi, udara masuk melalui hidung");
        System.out.println("Trakea mengirimkan udara ke paru-paru");
        System.out.println("Otot tulang rusuk relaksasi, udara dikeluarkan melalui hidung");
    }
